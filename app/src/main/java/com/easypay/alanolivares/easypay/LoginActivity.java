...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!correo.equals("No existe")){
            if(isOnlineNet()){
                ...
                Intent re = new Intent(LoginActivity.this, Aplicacion.class);
                startActivity(re);
            }
        }
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            new ConsultarDatos().execute("http://10.10.26.195/easypay/consulta.php?correo="+mEmailView.getText());
        }
    }
    ...
    private class ConsultarDatos extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                verificar=ja.getString(4);
                vercorreo=ja.getString(3);
                nom=ja.getString(0);
